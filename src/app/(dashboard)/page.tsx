...
export default function Page() {
  ...
  return (
    <main className={`h-full overflow-y-auto`}>
        ...
        <StatsWithDescription theme={theme} />
    
        <StatsSimpleGrid theme={theme} />
    
        <FooterFourColumnWithNewsletterBelow theme={theme} />
    
        <NewsletterCenteredCard theme={theme} />
    
        <FooterFourColumnWithCompanyMission theme={theme} />
        ...
        <FooterFourColumnWithNewsletter theme={theme} />
    
        <FooterSocialLinksOnly theme={theme} />
    
        <NewsletterSimpleStacked theme={theme} />
    
        <NewsletterSimpleSideBySide theme={theme} />
    
        <NewsletterSideBySideOnCard theme={theme} />
    
        <FaqsOffsetWithSupportingText theme={theme} />
    
        <FaqsCenteredAccordion theme={theme} />
    
        <StatsSplitWithImage theme={theme} />
    
        <StatsSimple theme={theme} />
    
        <CtaTwoColumnsWithPhoto theme={theme} />
    
        <CtaSimpleJustified theme={theme} />
    
        <CtaSimpleCentered theme={theme} />
    
        <CtaWithAppScreenshot theme={theme} />
    
        <TestimonialsOffWhiteGrid theme={theme} />
    
        <TestimonialsGrid theme={theme} />
    
        <HeroWithPhoneMockup theme={theme} />
    
        <HeroWithAngledImageOnRight theme={theme} />
    
        <HeroSplitWithScreenshot theme={theme} />
    
        <HeroSplitWithImage theme={theme} />
    
        <HeroSimpleCentered theme={theme} />
